...
//		final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.example_picture);
		...
		final String title = "title";//res.getString(R.string.game_notification_title_template, exampleString);
		final String text = "text";//res.getString(R.string.game_notification_placeholder_text_template, exampleString);
